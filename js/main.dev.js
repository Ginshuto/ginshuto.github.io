...
new WOW({
  boxClass: "canvas__title"
}).init(); // Initialisation du localScroll

$(document).ready(function () {
  $("body").localScroll();
});
var keyCodeArray = []; // Script activant et désactivant la transparence du header, en fonction de la position sur la page

$(document).ready(function () {
  var header = $("header").height();
  var whoAmI = $("#Qui-suis-je").height();
...
new Splide("#splide", {
  ...
  keyboard: true,
  lazyLoad: "nearby"
}).mount(); // Script d'envoi de mail https://formspree.io
